 ...
 * Licensed under MIT
 */
tinymce.PluginManager.add('tpLineheight', function(editor, url) {
    var pluginName='设置行高';
    ...
    editor.ui.registry.addSplitButton('tpLineheight', {
        icon: 'line-height',
        tooltip: pluginName,
    ...
    editor.ui.registry.addNestedMenuItem('tpLineheight', {
        text: pluginName,
        icon: 'line-height',
