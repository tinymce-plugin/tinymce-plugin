 ...
 * Licensed under MIT
 */
tinymce.PluginManager.add('tp-lineheight', function(editor, url) {
    var pluginName='设置行高';
    ...
    editor.ui.registry.addSplitButton('tp-lineheight', {
        icon: 'line-height',
        tooltip: pluginName,
    ...
    editor.ui.registry.addNestedMenuItem('tp-lineheight', {
        text: pluginName,
        icon: 'line-height',
