...
*/(function(g,p){typeof exports=="object"&&typeof module<"u"?p(exports):typeof define=="function"&&define.amd?define(["exports"],p):(g=typeof globalThis<"u"?globalThis:g||self,p(g["tinymce-plugin"]={}))})(this,function(g){"use strict";let p=tinymce,E=p.util.Tools,x=p.html.Node;p.html.Schema;let F=p.util.XHR,L=p.util.I18n,X=new p.html.Serializer().serialize,Y=new p.html.DomParser().parse,f={};window.tp$State=f;let c=(t,e)=>{let o=e?e.match(new RegExp(t+':(.+?)"?[;}]')):"";return o?o[1]:!1};function H(t,e,o,a){t.tp$Style.mapping&&t.tp$Style.mapping[""+e.getAttribute("data-id")]&&(t.tp$Style.mapping[""+e.getAttribute("data-id")].specialStyle[""+o]=a)}let u={customTags:{}},S=Object.keys,h=function(){return h=Object.assign||function(t){for(var e,o=1,a=arguments.length;o<a;o++){e=arguments[o];for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=e[n])}return t},h.apply(this,arguments)},W=Object.hasOwnProperty;var Z=function(t){return t==null},G=function(t){return!Z(t)};const k=t=>{if(typeof t=="object")return JSON.stringify(t).replace(/"([-A-Za-z]+?)":""[,}]/g,"").replace(/,/gi,";").replace(/{/gi,"").replace(/}/gi,"").replace(/"/gi,"")},z=t=>typeof t=="string"&&t!=="{}"?(t=JSON.stringify(t),JSON.parse(("{"+t.replace(/:/g,'": "').replace(/;\s*/g,'","')+"}").replace(/,\"\"\}$/,"}"))):t,_=(t,e)=>{const o=e.match(new RegExp(`.${t}\\s*\\{([\\s\\S]+)\\}`));return o&&o[1]?o[1].replace(/\}([\s\S]+)/,"").trim():""};var K=function(t,e){return W.call(t,e)},Q=function(t,e,o,a){a===void 0&&(a=null);var n=t.attr(o);return G(n)?n:K(e,o)?null:a};const A=t=>t.replace(/[-|\_](\w)/g,function(e,o){return o.toUpperCase()}),tt=t=>t.replace(/([A-Z])/g,"_$1").toLowerCase().replace(/\-/g,"_"),et=t=>t.replace(/([A-Z])/g,"-$1").toLowerCase().replace(/\_/g,"-");var at=function(t,e){let o="";if(!t)return"";for(e=A(e);t.nodeName!=="P"&&t.nodeName!=="LI"&&t.nodeName!=="DIV"&&t.nodeName!=="BODY";){if(t.style[e]){o=t.style[e];break}t=t.parentNode}return o};let w=(t,e)=>{let o="";return o+=t["tp-buttons"]?'.tp-buttons[data-tp-style="'+e+'"] {'+t["tp-buttons"]+`}
`:"",o+=t["tp-buttons:hover"]?'.tp-buttons[data-tp-style="'+e+'"]:hover {'+t["tp-buttons:hover"]+`}
`:"",o+=t["tp-buttons::before"]?'.tp-buttons[data-tp-style="'+e+'"]::before {'+t["tp-buttons::before"]+`}
`:"",o+=t["tp-buttons::after"]?'.tp-buttons[data-tp-style="'+e+'"]::after {'+t["tp-buttons::after"]+`}
`:"",o};const ot=(t,e,o)=>{!o&&(o=e*100);let a={id:null,outTime:o,outId:null};a.id=setInterval(n=>{t(()=>{clearTimeout(n.outId),clearInterval(n.id)})},e,a),a.outId=setTimeout(()=>{a.id&&clearInterval(a.id)},a.outTime)};let v=function(t,e){return typeof t[e]=="function"?t[e]:typeof u.customTags[t.name][e]=="function"?u.customTags[t.name][e]:function(){}};const nt=(t,e)=>e?typeof t=="string"&&!t.match(/\s/)&&t.length>0?parseInt(t)+"px":t:typeof t=="string"&&t.length>0&&t.match(/^[0-9]{1,8}$/)?t+"px":t,M=t=>{let e=t.split("_");return e.length>1?L.translate([e[0]+" {0}",e[1]]):L.translate(t)};tinymce.tp$HtmlPanelFn=window.tp$HtmlPanelFn=function(t,e,o){f.buttonsStyle&&(f.buttonsStyle[e]=o),document.querySelector("#"+e+"_StyleID").innerHTML=t.nextElementSibling.innerHTML};const st={count:0},lt=t=>{let e=new Date().getTime()+"-"+st.count++,o=`
...
`;return document.querySelector(t.selector).outerHTML=o+document.querySelector(t.selector).outerHTML,e},it=(t,e,o)=>{let a="";a=f.buttonsStyle&&f.buttonsStyle[e],o||(o=S(t.tp$CustomTags.buttons.styleSheetList)),a||(a=f.buttonsStyle&&(f.buttonsStyle[e]=o[0]));let n="",s="",i="";return o.forEach((l,r)=>{l===a&&(s=`<span class="tp-buttons" data-tp-style="${l}">${M(l)}</span>`),n+=`<li ><input id="${e+"_"+r}" type="radio" name="${e}" ${a===l?" checked ":""}  onclick="tinymce.tp$HtmlPanelFn(this,'${e}','${l}')"> <label for="${e+"_"+r}" > <span class="tp-buttons" data-tp-style="${l}">${M(l)}</span></label></li>
`,i+=w(t.tp$CustomTags.buttons.styleSheetList[l],l)}),`<div style="width: 100%; position: relative; " >
  ...
  :host {
      overflow: hidden;
      display: block; 
  }`,s.innerHTML=a.template.innerHTML;class r extends t.HTMLElement{constructor(){super();this.setAttribute("contenteditable",!1),this.setAttribute("data-mce-tp-component",n),this.attachShadow({mode:"open"}),this.tp$state=typeof a.state=="object"?JSON.parse(JSON.stringify(a.state)):{},$(o,this,"init",a),this.tpComponentDelete=typeof a.tpComponentDelete=="function"?a.tpComponentDelete.bind(this):()=>{this.remove()},this.tpComponentCmd=typeof a.tpComponentCmdFn=="object"?JSON.stringify(a.tpComponentCmdFn)!=="{}"?(b,y)=>{a.tpComponentCmdFn[b](this,y),$(o,this,b,a)}:(b,y)=>{u.customTags[n].tpComponentCmdFn[b](this,y),$(o,this,b,a)}:()=>{console.log("\u65E0\u53EF\u7528cmd")},l.id="tpComponentStyle_"+this.getAttribute("data-id"),n=="tabs"&&(l.textContent=a.styleSheetLoadList&&a.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"]?a.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"].replace(/.tp-tabs\s*\{/g,":host   {").replace(/.tp-tabs_label\b\s/g,"::slotted(.tp-tabs_label)   ").replace(/.tp-tabs_label:hover\b\s/g,"::slotted(.tp-tabs_label:hover)   ").replace(/.tp-tabs_label.checked\b\s/g,"::slotted(.tp-tabs_label.checked)   "):""),n=="collapse"&&(l.textContent=a.styleSheetLoadList&&a.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"]?a.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"].replace(/>/g," ").replace(/.tp-collapse\s*\{/g,":host   {").replace(/label.tp-collapse_label\b\s/g,"::slotted(.tp-collapse_label)   ").replace(/label.tp-collapse_label::/g,"::slotted(.tp-collapse_label)::").replace(/.tp-tabs_label:hover\b\s/g,"::slotted(.tp-tabs_label:hover)   ").replace(/.tp-tabs_label.checked\b\s/g,"::slotted(.tp-tabs_label.checked)   "):""),n=="buttons"&&(l.textContent=a.styleSheetList&&a.styleSheetList[this.getAttribute("data-tp-style")||"default"]?w(a.styleSheetList[this.getAttribute("data-tp-style")||"default"],this.getAttribute("data-tp-style")||"default").replace(/\[data-tp-style=(.*?)\]/g,"").replace(/>/g," ").replace(/.tp-buttons\s*\{/g,":host   {").replace(/.tp-buttons:hover\s*\{/g,":host(:hover)   {").replace(/.tp-buttons::before\s*\{/g,":host(.tp-buttons)::before   {").replace(/.tp-buttons::after\s*\{/g,":host(.tp-buttons)::after   {"):""),s.content.prepend(l),s.content.prepend(i),this.shadowRoot.appendChild(s.content.cloneNode(!0))}connectedCallback(){v(a,"headerEditableFn")(this,a.isHeaderEditable,n,o),v(a,"contentEditableFn")(this,a.isContentEditable,n,o),v(a,"connectedCallback")(this.shadowRoot,this)}static get observedAttributes(){return["data-top-bg","data-mce-tp-component","data-value"]}static tp$Delete(){console.log(this)}}try{t.customElements.define("tp-"+n,r)}catch{}},ct=t=>{const e=t.getWin(),o=t.getDoc();F.send({url:"/tinymce/plugins/tpIconlists/tpIconlists.css",async:!1,dataType:"text",success:function(s){t.dom.addStyle(s)}}),F.send({url:"/tinymce/css/iconfont.css",async:!1,dataType:"text",success:function(s){t.dom.addStyle(s)}}),dt(t),rt(t);const a=`.mce-content-body [data-mce-tp-component][contenteditable=false][data-mce-selected] {
      outline: none;
      cursor: default;
  ...
  .mce-content-body *[contentEditable=false] *[contentEditable=true]:hover {
      outline: none!important;
  }`;t.dom.addStyle(a),t.tp$Style={},t.getTpStyle=s=>"<style>"+t.tp$OutputStyle+" </style>";let n=t.tp$CustomTags||u.customTags;E.each(n,function(s,i){pt(e,o,t,s,i)}),t.parser.addAttributeFilter("data-tp-component",s=>{s.forEach(i=>{let l=i.attr("data-tp-component");n[l]&&v(n[l],"parserFn")(i,l,t)})}),t.serializer.addAttributeFilter("data-mce-tp-component",s=>{s.forEach(i=>{let l=i.attr("data-mce-tp-component");n[l]&&v(n[l],"serializerFn")(i,l,t)})}),t.setContent(t.getContent({source_view:!0}))},N=(t,e,o,a,n)=>{a?(!a.tp$CustomTags&&(a.tp$CustomTags=JSON.parse(JSON.stringify(u.customTags))),n?h(a.tp$CustomTags[t][e],o):a.tp$CustomTags[t][e]=o):n?h(u.customTags[t][e],o):u.customTags[t][e]=o},V={custom_elements:"",setCustomTags:N,createCustomTags:(t,e,o)=>{o?(!o.tp$CustomTags&&(o.tp$CustomTags=JSON.parse(JSON.stringify(u.customTags))),o.tp$CustomTags[t]=e):u.customTags[t]=e},setStyleSheetList:(t,e,o,a)=>{N("buttons","styleSheetList",{[e]:{"tp-buttons":_("tp-buttons",o),"tp-buttons:hover":_("tp-buttons:hover",o),"tp-buttons::before":_("tp-buttons::before",o),"tp-buttons::after":_("tp-buttons::after",o)}},a,!0)},createHtmlPanel:it};var D={name:"tabs",styleSheet:{selector:"default",styleSheetList:{default:{"tp-tabs":"","tp-tabs_top":"","tp-tabs_label.checked":" ","tp-tabs_main":" ","tp-tab_main.checked":" "}}},styleSheetLoadList:{},styleFn:()=>{},state:{count:0},tpComponentDeleteFn:function(){console.log(this)},tpComponentMonitorCmd:()=>{},tpComponentCmdFn:{tabAdd:(t,e)=>{let o=document.createElement("div");o.setAttribute("contenteditable",!1),o.setAttribute("class","tp-partition tp-tabs_label"),o.setAttribute("data-idx",t.tp$state.count);let a=document.createElement("p");a.setAttribute("class","tp-component_inline"),a.setAttribute("data-idx",t.tp$state.count),a.setAttribute("contenteditable",!0),a.innerHTML=e.title,o.appendChild(a),t.insertBefore(o,t.lastChild);let n=document.createElement("div");n.setAttribute("class","tp-tab_main"),n.setAttribute("style","overflow: hidden; max-height: 0; transition: all 0s"),n.innerHTML=e.content,t.lastChild.appendChild(n),t.tp$state.count++},tabDelete:(t,e)=>{t.children[--t.tp$state.count].remove(),t.lastChild.lastChild.remove()},delete:(t,e)=>{t.remove()},getStyle:(t,e)=>{},setStyle:(t,e)=>{console.log(t.querySelector(".tp-tabs_top")),t.setAttribute("data-top-style",e["tp-tabs_top"]),t.shadowRoot.querySelector(".tp-tabs_top").setAttribute("style",e["tp-tabs_top"])}},template:{innerHTML:`
<div class="tp-tabs">
  ...
  <div class="tp-tabs_main">
    ...
    `},connectedCallback:(t,e)=>{let o=a=>a.className&&a.className.indexOf("tp-partition tp-tabs_label")!==-1||a.parentNode&&(a.parentNode.className&&a.parentNode.className.indexOf("tp-partition tp-tabs_label")!==-1||a.parentNode.parentNode&&a.parentNode.parentNode.className&&a.parentNode.parentNode.className.indexOf("tp-partition tp-tabs_label")!==-1);t.getElementById("headerID").addEventListener("click",function(a){if(o(a.target)){let n=a.target.getAttribute("data-idx")||a.target.parentNode.getAttribute("data-idx")||"0",s=e.querySelectorAll("div.tp-partition.tp-tabs_label"),i=e.querySelector("div.tp-partition.tp-tabs_label.checked");i&&i.setAttribute("class","tp-partition tp-tabs_label");let l=s[n];l&&l.setAttribute("class","tp-partition tp-tabs_label checked");let r=e.querySelectorAll("div.tp-tab_main"),m=e.querySelector("div.tp-tab_main[contenteditable=true]");m&&(m.setAttribute("contenteditable",!1)||(m.style.maxHeight="0px"));let b=r[n];b&&(b.setAttribute("contenteditable",!0)||(b.style.maxHeight="10000px"))}})},isContentEditable:!0,contentEditableFn:(t,e,o)=>{if(t.lastChild&&t.lastChild.className==="tp-"+o+"_main"){const a=document.createElement("div");for(a.setAttribute("contenteditable",!1),a.setAttribute("class","tp-partition tp-tabs_main"),a.setAttribute("slot","content"),t.lastChild.firstChild&&(t.lastChild.firstChild.setAttribute("class","tp-tab_main"),t.lastChild.firstChild.setAttribute("style","overflow: hidden; max-height: 10000px; transition: all 0s"),e&&t.lastChild.firstChild.setAttribute("contenteditable",!0),a.setAttribute("style",t.lastChild.getAttribute("style")),a.appendChild(t.lastChild.firstChild));t.lastChild.firstChild;)t.lastChild.firstChild.setAttribute("class","tp-tab_main"),t.lastChild.firstChild.setAttribute("style","overflow: hidden; max-height: 0; transition: all 0s"),a.appendChild(t.lastChild.firstChild);t.removeChild(t.lastChild),t.appendChild(a)}},isHeaderEditable:!0,headerEditableFn:(t,e,o)=>{let a=t.children.length;t.getAttribute("data-id"),t.shadowRoot.querySelector("#headerID.tp-tabs_top").setAttribute("style",t.getAttribute("data-top-style")?t.getAttribute("data-top-style"):"");for(let n=a-2;n>=0;n--)t.tp$state.count++,t.children[n].setAttribute("contenteditable",!1),t.children[n].setAttribute("class","tp-partition tp-"+o+"_label"+(n===0?" checked":"")),t.children[n].setAttribute("data-idx",n),t.children[n].firstChild.setAttribute("class","tp-component_inline"),t.children[n].firstChild.setAttribute("data-idx",n),e&&t.children[n].firstChild.setAttribute("contenteditable",!0)},parserFn:(t,e)=>{for(t.attr({"data-tp-component":null,"data-mce-tp-component":e,"data-top-style":t.firstChild.attr("style")});t.firstChild.name==="input";)t.firstChild.remove();let o=t.firstChild.firstChild;for(;o&&o.name==="label";){let a=o.next,n=new x("div",1);o.name="p",o.wrap(n),o=a}t.firstChild.unwrap(),t.type=1,t.name="tp-"+e},serializerFn:(t,e)=>{t.attr({"data-mce-tp-component":null,"data-tp-component":e,contenteditable:null,class:"tp-"+e});let o=new x("div",1);o.attr("class","tp-tabs_top"),o.attr("style",t.attr("data-top-style")),t.attr("data-top-style",null);let a=t.firstChild,n=[];for(;a.attr("data-idx");){let l=a.next;a.firstChild.name="label",a.firstChild.attr({contenteditable:null,"data-idx":null,class:"tp-"+e+"_label",for:t.attr("data-id")+"tab"+a.attr("data-idx")}),n.push(X(a.firstChild)),o.append(a.firstChild),a.remove(),a=l}let s=t.lastChild.firstChild,i=0;for(;s&&s.attr("class")==="tp-tab_main";){let l=s.next,r=new x("input",1);r.shortEnded=!0,r.attr({id:t.attr("data-id")+"tab"+i,type:"radio",name:t.attr("data-id")}),i==0&&r.attr("checked",""),t.append(r),s.attr({contenteditable:null,style:null,class:"tp-tab_main tp-tab_main_"+i}),t.lastChild.insert(Y(n[i]),s,!0),i++,s=l}t.append(o),t.firstChild.attr({contenteditable:null,class:"tp-tabs_main"}),t.append(t.firstChild),t.type=1,t.name="div"}},I={name:"buttons",template:{innerHTML:`
...
<div class="tp-buttons_main">
    ...
    `},styleSheetList:{default:{"tp-buttons":`
          ...
          text-decoration: none;`,"tp-buttons:hover":`
           ...
           `,"tp-buttons::before":" ","tp-buttons::after":" "}},isContentEditable:!0,connectedCallback:()=>{},tpComponentCmdFn:{upData:(t,e)=>{t.shadowRoot.children[1].textContent=w(e.editor.tp$CustomTags.buttons.styleSheetList[e.styleName],e.styleName).replace(/\[data-tp-style=(.*?)\]/g,"").replace(/>/g," ").replace(/.tp-buttons\s*\{/g,":host   {").replace(/.tp-buttons:hover\s*\{/g,":host(:hover)   {").replace(/.tp-buttons::before\s*\{/g,":host(::before)   {").replace(/.tp-buttons::after\s*\{/g,":host(::after)   {")}},contentEditableFn:(t,e,o,a)=>{if(t.firstChild&&t.firstChild.tagName==="A"){const n=document.createElement("p");n.setAttribute("contenteditable",!0),n.setAttribute("class","tp-component_inline"),t.firstChild.innerHTML="<span>"+t.firstChild.innerHTML+"</span>",t.firstChild.setAttribute("href","javascript:;"),n.appendChild(t.firstChild),t.appendChild(n)}},isHeaderEditable:!0,parserFn:(t,e,o)=>{t.attr({"data-tp-component":null});let a=t.attr("style"),n={},s="";s=c("margin",a),s&&(n.margin=s),s=c("padding",a),s&&(n.padding=s),s=c("border",a),s&&(n.border=s),s=c("background",a),s&&(n.background=s),s=c("border-radius",a),s&&(n["border-radius"]=s),s=c("border-width",a),s&&(n["border-width"]=s),s=c("border-style",a),s&&(n["border-style"]=s),s=c("border-color",a),s&&(n["border-color"]=s);let i=new x("div",1);i.type=1,i.attr({"data-mce-tp-component":e,"data-tp-style":t.attr("data-tp-style")||"default",style:k(n)||null,"data-id":t.attr("data-id")}),t.attr("class")&&i.attr("class",t.attr("class")),o.tp$Style.mapping||(o.tp$Style.mapping={}),o.tp$Style.mapping[""+t.attr("data-id")]?h(o.tp$Style.mapping[""+t.attr("data-id")],{styleTemplate:t.attr("data-tp-style")||"default"}):o.tp$Style.mapping[""+t.attr("data-id")]={styleCustomTags:"buttons",stylePath:"styleSheetList",styleTemplate:t.attr("data-tp-style")||"default",specialStyle:{}},t.attr("style",k(h(z(t.attr("style"))||{},{margin:"",padding:"",background:"","border-style":"","border-color":"","border-width":"","border-radius":"",border:""}))||null),t.attr("data-id",null),t.attr("data-mce-style",null),t.wrap(i),i.name="tp-"+e},serializerFn:(t,e)=>{let o=t;for(;o.name!=="a"&&o.firstChild.name!=="#text";)o=o.firstChild;t.attr({"data-mce-tp-component":null,"data-tp-component":e,contenteditable:null,"data-tp-style":t.attr("data-tp-style")||"default",href:o&&o.attr("href")?o.attr("href"):null,style:o&&o.attr("style")?k(h(z(t.attr("style"))||{},z(o.attr("style"))||{})):t.attr("style"),target:o&&o.attr("target")?o.attr("target"):null,rel:o&&o.attr("rel")?o.attr("rel"):null,title:o&&o.attr("title")?o.attr("title"):null}),t.firstChild.unwrap(),o&&o.unwrap(),t.name="a"}},P={name:"collapse",template:{innerHTML:`
...
<div class="tp-collapse_mainBox">
    ...
    `},isContentEditable:!0,connectedCallback:()=>{},tpComponentCmdFn:{upData:(t,e)=>{let o=e.style,a=c("padding",o),n=c("border",o),s=c("border-width",o);H(e.editor,t,"tp-collapse_main",(a?"padding: "+a+"!important; ":"")+(n?"border: "+n+"!important;":"")+(s?"border-width: "+s+"!important;":""))}},contentEditableFn:(t,e,o,a)=>{const n=document.createElement("div");if(n.setAttribute("contenteditable",!1),n.setAttribute("class","tp-partition tp-collapse_main"),e&&t.lastChild.setAttribute("contenteditable",!0),t.lastChild.getAttribute("class")==="tp-collapse_main"){let s=t.lastChild.getAttribute("style"),i=c("padding",s),l=c("border",s),r=c("border-width",s);H(a,t,"tp-collapse_main",(i?"padding: "+i+"!important; ":"")+(l?"border: "+l+"!important;":"")+(r?"border-width: "+r+"!important;":""))}n.appendChild(t.lastChild),t.appendChild(n)},isHeaderEditable:!0,headerEditableFn:(t,e,o,a)=>{if(t.firstChild.contenteditable!=="true"){const n=document.createElement("div");for(e&&n.setAttribute("contenteditable",!0),n.setAttribute("slot","header"),n.setAttribute("class","tp-collapse_label"),n.setAttribute("style","min-height: 20px; "+t.getAttribute("data-top-style"));t.firstChild&&t.firstChild.className!=="tp-"+o+"_main";)n.appendChild(t.firstChild);t.insertBefore(n,t.firstChild)}},parserFn:(t,e)=>{t.attr({"data-tp-component":null,"data-mce-tp-component":e}),t.attr("data-id",t.firstChild.attr("id")),t.firstChild.remove(),t.lastChild.attr("class","tp-"+e+"_main"),t.type=1,t.name="tp-"+e},serializerFn:(t,e)=>{t.attr({"data-mce-tp-component":null,"data-tp-component":e,contenteditable:null,class:"tp-"+e}),t.firstChild.type=1,t.firstChild.name="label",t.firstChild.attr({contenteditable:null,for:t.attr("data-id")});let o=t.lastChild.attr("style");t.lastChild.unwrap(),t.lastChild.attr({contenteditable:null,class:"tp-"+e+"_main",style:o});let a=new x("input",1);a.shortEnded=!0,a.attr({id:t.attr("data-id"),type:"checkbox"}),t.insert(a,t.firstChild,!0),t.attr("data-id",null),t.type=1,t.name="div"}};const O=t=>/select$/.test(t),j={forecolor:!0,backcolor:!0,tpLetterspacing:!0,tpIconlists:!0,tpColumns:!0,table:!0},C={title:{file:{zh_CN:"\u6587\u4EF6",en_US:"File"},edit:{zh_CN:"\u7F16\u8F91",en_US:"Edit"},view:{zh_CN:"\u89C6\u56FE",en_US:"View"},insert:{zh_CN:"\u63D2\u5165",en_US:"Insert"},format:{zh_CN:"\u683C\u5F0F",en_US:"Format"},table:{zh_CN:"\u8868\u683C",en_US:"Table"},tools:{zh_CN:"\u5DE5\u5177",en_US:"Tools"},help:{zh_CN:"\u5E2E\u52A9",en_US:"Help"}},items:{code:"tools",spellchecker:"tools",spellcheckerlanguage:"tools",wordcount:"tools",image:"insert",link:"insert",media:"insert",hr:"insert",template:"insert",codesample:"insert",charmap:"insert",inserttable:"table",emoticons:"insert",pagebreak:"insert",nonbreaking:"insert",anchor:"insert",toc:"insert",insertdatetime:"insert",bold:"format",italic:"format",underline:"format",strikethrough:"format",blockquote:"format",subscript:"format",superscript:"format",removeformat:"format",formatselect:"format",fontselect:"format",fontsizes:"format",forecolor:"format",backcolor:"format",fontformats:"format",blockformats:"format",codeformat:"format",align:"format",table:"table",lineheight:"format",help:"help"}},q={file:!0,view:!0,edit:!0},R=t=>{let e=[];return t.split("|").forEach(o=>{let a=o.split(" "),n=[];a.forEach(s=>{s&&n.push({isSelect:O(s),name:s}),s&&C.items[s]&&(q[C.items[s]]=!0)}),n.length>0&&e.push(n)}),e},ut=t=>{let e=[];return t.split("|").forEach(o=>{let a=o.split(" "),n=[];a.forEach(s=>{s&&n.push({isSelect:O(s),name:s})}),e.push(n)}),e},J=()=>`.skt-tox-tinymce{
  ...
  }`,bt=t=>{if(!document.querySelector("style#skt-tox-style")){let r=document.createElement("style");r.type="text/css",r.id="skt-tox-style";try{r.appendChild(document.createTextNode(J()))}catch{r.styleSheet.cssText=J()}document.getElementsByTagName("head")[0].appendChild(r)}let e=[];typeof t.toolbar=="string"?e=R(t.toolbar):Array.isArray(t.toolbar)&&t.toolbar.forEach(r=>{e.push(...R(r))});let o=[];if(t.menubar!==!1)if(typeof t.menubar=="string")o=ut(t.menubar);else for(let r in C.title)q[r]&&o.push(C.title[r][t.language||"en_US"]);let a=t.min_height||t.height||200,n=[],s=a-150;for(let r=0;r<s;r+=50)n.push("1");let i=t.selector?document.querySelector(t.selector).parentNode:t.target.parentNode,l=document.createElement("div");return l.className="skt skt-loading",l.innerHTML=ft({selector:t.selector,toolbar:e,menubar:o,branding:t.branding!==!1,placeholderList:n,height:a}),i.style.position="relative",i.style.minHeight=a+"px",i.append(l),l},ht=t=>{let e="";return t.forEach(o=>{e+='<button  class="skt-tox-mbtn skt-tox-mbtn--select"><span class="skt-tox-mbtn__select-label skeleton">'+o+`</span></button>
`}),e},mt=t=>{let e="";return t.forEach(o=>{e+=`<div class="skt-tox-toolbar__group">
`,o.forEach(a=>{e+='<button class="skt-tox-tbtn '+(a.isSelect?" skt-tox-tbtn--select":"")+(j[a.name]?" skt-tox-split-button":"")+'"><span class="'+(a.isSelect?"skt-tox-tbtn__select-label skt-tox-tbtn--select":"skt-tox-icon tox-tbtn__icon-wrap")+' skeleton">'+a.name+"</span>"+(a.isSelect||j[a.name]?'<div class="skt-tox-tbtn__select-chevron skeleton"></div>':"")+`</button>
`}),e+=`</div>
`}),e},gt=t=>{let e="";return t.forEach(o=>{e+=`<p class="skeleton"></p>
`}),e},ft=t=>`
...
</div>`;u.customTags[D.name]=D,u.customTags[I.name]=I,u.customTags[P.name]=P;let yt=(t,e,o)=>{let a=`
`;for(let n=0;n<o;n++)a+=`.tp-${t} > input:nth-child(${n+1}):checked ~ .tp-${t}_top > .tp-${t}_label:nth-child(${n+1}){${e}}

               .tp-${t} > input:nth-child(${n+1}):checked ~ .tp-${t}_main  .tp-tab_main_${n}{ max-height: 10000px; }

            `;return a},xt=(t,e)=>{let o="";return S(t.specialStyle).forEach(a=>{o+=t.specialStyle[a]?`
 `+e[a]+" { "+t.specialStyle[a]+"} ":""}),o},vt=t=>{t.tp$OutputStyle="";let e=2,o="",a="",n="",s="",i={},l={},r={};t.tp$Style&&t.tp$Style.mapping&&(!t.tp$CustomTags&&(t.tp$CustomTags=JSON.parse(JSON.stringify(u.customTags))),S(t.tp$Style.mapping).forEach(y=>{let d=t.tp$Style.mapping[y];d.styleCustomTags==="tabs"&&(i[d.styleTemplate]||(o=t.tp$CustomTags[d.styleCustomTags][d.stylePath][d.styleTemplate],i[d.styleTemplate]=!0),e<d.quantity&&(e=d.quantity)),d.styleCustomTags==="collapse"&&(l[d.styleTemplate]||(n+=t.tp$CustomTags[d.styleCustomTags][d.stylePath][d.styleTemplate],l[d.styleTemplate]=!0),s+=d.specialStyle?xt(d,{"tp-collapse_main":'.tp-collapse > input[id="'+y+'"]:checked + .tp-collapse_label + .tp-collapse_main'}):""),d.styleCustomTags==="buttons"&&!r[d.styleTemplate]&&(a+=w(t.tp$CustomTags[d.styleCustomTags][d.stylePath][d.styleTemplate],d.styleTemplate),r[d.styleTemplate]=!0)}));let m="",b="";o&&(o=o.replace(/.tp-tabs\s*{/g,"div.tp-tabs[data-id] {").replace(/\n.tp-tabs\s/g,`
.tp-tabs[data-id] `)+`.tp-tabs[data-id] > input { display: none;} 
 .tp-tabs .tp-tabs_main .tp-tab_main { overflow: hidden;max-height: 0px;}`,m=o.match(/.tp-tabs_label.checked\s*{\n([\s\S]+)\n}/)[1],b=m?yt("tabs",m,e):""),t.tp$OutputStyle=(a?`@font-face {
...
}`:"")+a+n+s+o+b};const kt={iframeLayout:`
   <style>
